...
////                            .addAction(R.mipmap.ic_launcher,"Remind later",)
...
//                    notif_id++
//                }
                val intentnotif = Intent(view.context,ChannelAndNotifReceiver::class.java)
                intentnotif.putExtra(EXTRA_STOK, stockDetail)
                requireActivity().sendBroadcast(intentnotif)
